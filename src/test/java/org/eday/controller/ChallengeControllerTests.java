...
public class ChallengeControllerTests {
	...
	public void createChallengeTest() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/createChallenge")
				.param("challenge_id", " ")
				.param("regDate", "2022-01-01")
				.param("startDate", "2022-01-01")
				.param("finishDate", "2021-02-01")
				.param("detail", "올해는 꼭 텀블러좀 쓰자!!!!!")
				.param("owner_id", "4")
				.param("subject_id", "3"))
